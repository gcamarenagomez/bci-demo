...
/// The navigation bar text color key.
SC_EXTERN NSString * const SCSAppearanceNavbarInvertedColor;

/// The text color key used for header text.
SC_EXTERN NSString * const SCSAppearancePrimaryBrandInvertedColor;

__attribute__((deprecated("SCSAppearanceTitleTextColor has been deprecated please use SCSAppearancePrimaryBrandInvertedColor instead")))
...
SC_EXTERN NSString * const SCSAppearanceSecondaryBrandInvertedColor;

__attribute__((deprecated("SCSAppearanceBrandContrastColor has been deprecated please use SCSAppearanceSecondaryBrandInvertedColor instead")))
