...
/**
 Protocol defining a type of UIViewController that can be used to display action views.  The current implementation of this protocol is SCSActionButtonViewController.
 */
 ...
 */
- (void)addActionView:(UIView<SCSActionItem>*)view forName:(NSString*)name atSortIndex:(NSInteger)sortIndex animated:(BOOL)animated;
 ...
 */
- (void)removeActionViewForName:(NSString*)name animated:(BOOL)animated;
 ...
 */
- (nullable UIView<SCSActionItem>*)actionViewForName:(NSString*)name;
 ...
 */
- (NSArray<NSString*>*)visibleActionNames;
