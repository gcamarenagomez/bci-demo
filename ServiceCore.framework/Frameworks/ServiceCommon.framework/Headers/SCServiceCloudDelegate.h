...
/**
 ...
 @return Transitioning delegate that should control the controller presentation, or `nil` to accept the system defaults.
 */
- (nullable NSObject<UIViewControllerTransitioningDelegate>*)serviceCloud:(SCServiceCloud *)serviceCloud transitioningDelegateForPresentedController:(UIViewController*)presentedController presentingController:(UIViewController*)presentingController;
