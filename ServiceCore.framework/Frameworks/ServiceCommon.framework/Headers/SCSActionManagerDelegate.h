...
/**
 ...
 The view is expected to trigger the action as needed using the `[SCServiceCloud performActionWithName:actionItem:]`.
 
 @param actionManager `SCSActionManager` instance.
 @param name Action name.
 @return UIView conforming to SCSActionItem to represent the given action, or `nil` to accept the system default.
 */
- (nullable __kindof UIView<SCSActionItem> *)actionManager:(SCSActionManager*)actionManager viewForActionItemWithName:(NSString*)name;
 ...
 */
- (NSInteger)actionManager:(SCSActionManager*)actionManager sortIndexForActionItemWithName:(NSString*)name;
 ...
 */
- (nullable NSSet<NSString*>*)actionManager:(SCSActionManager *)actionManager actionsToShowForViewController:(nullable UIViewController*)controller withDefaultActions:(NSSet<NSString*>*)defaultActions;
...
/**
 ...
 If the resulting container visibility is different from the current state, the appropriate change will be made, and the accompanying `actionManager:containerWillChangeVisibility:animated:` and `actionManager:containerDidChangeVisibility:animated:` methods will be invoked as needed.
 ...
 */
- (BOOL)actionManager:(SCSActionManager *)actionManager performActionWithName:(NSString*)actionName actionItem:(nullable UIView<SCSActionItem>*)actionItem;
 ...
 */
- (BOOL)actionManager:(SCSActionManager *)actionManager shouldShowActionWithName:(NSString*)name;
